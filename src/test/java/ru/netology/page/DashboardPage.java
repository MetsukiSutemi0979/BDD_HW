...
public class DashboardPage {
    ...
    private final SelenideElement card1 = $("[data-test-id=action-deposit");
    private final SelenideElement card2 = $("[data-test-id=action-deposit");
    ...
    public DashboardPage checkBalance() {
        card1Balance.shouldHave(Condition.exactText("**** **** **** 0001, баланс: 10100 р.\nПополнить"));
        card2Balance.shouldHave(Condition.exactText("**** **** **** 0002, баланс: 9900 р.\nПополнить"));
        return new DashboardPage();
    }

    public DashboardPage checkBalance2(){
        card2Balance.shouldHave(Condition.exactText("**** **** **** 0002, баланс: 10100 р.\nПополнить"));
        card1Balance.shouldHave(Condition.exactText("**** **** **** 0002, баланс: 9900 р.\nПополнить"));
        return new DashboardPage();
    }
